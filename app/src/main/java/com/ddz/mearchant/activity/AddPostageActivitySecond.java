...
public class AddPostageActivitySecond extends BaseActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.add_postage_address:
                ...
                intent.setClass(AddPostageActivitySecond.this,AddAddressProivinceActivity.class);
                if (listObj.size()>0){
