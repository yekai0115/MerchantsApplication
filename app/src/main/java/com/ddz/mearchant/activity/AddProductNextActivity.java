...
public class AddProductNextActivity extends BaseActivity implements View.OnClickListener{
...
//        }
    ...
    protected void initViews() {
        ...
        //默认20%分利
        //默认不上架
        int profit = addProductBase.getProfit();
        switch (profit){
            case 1:
    ...
    private void sumbitProductInfo(){
        APIService userBiz = RetrofitWrapper.getInstance().create(
                APIService.class);
        Call<BaseResponse<String>> call = userBiz.addGoodsPost(baseApplication.mUser.token,
            ...
            public void onResponse(Call<BaseResponse<String>> arg0,
                ...
                if (null != baseResponse) {
                    ...
                    if (status.equals(Constants.T_OK)){
                        ...
                        Intent intent = new Intent();
                        intent.setClass(AddProductNextActivity.this,MainActivity.class);
