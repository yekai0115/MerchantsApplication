...
public class ModifyPassWordActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void setNewPwd() {
        ...
        APIService userBiz = RetrofitWrapper.getInstance().create(
                APIService.class);
        Call<BaseResponse<String>> call = userBiz.resetPwdPost(baseApplication.mUser.token,editPhoneText.getText().toString(),reasetToken,pwd2);//"18813904075:123456789"
    ...
    private void validateCode() {
        ...
        APIService userBiz = RetrofitWrapper.getInstance().create(
                APIService.class);
        Call<BaseResponse<String>> call = userBiz.getResetPwdToken(baseApplication.mUser.token,editPhoneText.getText().toString(),editVercodeText.getText().toString());//"18813904075:123456789"
        call.enqueue(new HttpCallBack<BaseResponse<String>>() {
            @Override
            public void onResponse(Call<BaseResponse<String>> arg0,
                                   Response<BaseResponse<String>> response) {
