...
import com.ddz.mearchant.fragment.CustomerMessageFragment;
import com.ddz.mearchant.fragment.PlatformMessageFragment;
...
public class MyMessageActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void initViews() {
        ...
        htvCenter.setText("我的消息");
        htvLeft.setOnClickListener(this);
        platformMessageFragment = new PlatformMessageFragment();
        customerMessageFragment = new CustomerMessageFragment();
        fragments.add(platformMessageFragment);
        fragments.add(customerMessageFragment);
