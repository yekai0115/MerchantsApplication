 ...
 */
	...
	public GridViewAdapter(Context mContext,List<String> list,int maxNum) {
		super();
	...
	public View getView(final int position,View convertView, ViewGroup parent) {
		...
		{
			Glide.with(mContext).load(R.drawable.manage_details_add).fitCenter()
					.placeholder(R.drawable.manage_details_add).error(mContext.getResources().getColor(R.color.tab_text_diveder)).into(holder.item_grida_image);
