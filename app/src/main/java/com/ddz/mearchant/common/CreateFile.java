...
public class CreateFile {
	...
	public static final String SecondFolder = "ddz";// 二级目录
	...
	public static final String FeedbackFolder="feedback";  //投诉页面图片
	public static final String ReturnFolder="return";  //投诉页面图片
	public static final String ConpressFolder="conpress";  //投诉页面图片
