...
public class GivingReceiveRecordFragment extends BaseFragment implements PullToRefreshLayout.OnRefreshListener{
	//定义一个布局
	...
	public GivingReceiveRecordFragment(){
		super();
	}
	...
	class GivingRecordAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			try {
				holder.givingName.setText("支出账户:");
	...
	public void onLoadMore(final PullToRefreshLayout pullToRefreshLayout) {
		...
		if (!isLastRecord) {
			refreshCount++;
			pull = true;
			queryRecordList("2",String.valueOf(refreshCount));
		}
