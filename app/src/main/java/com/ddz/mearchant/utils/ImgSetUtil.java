...
public class ImgSetUtil {
    ...
    /**
     * Handle the bitmap and return the final path
     */
    public static String handleBitmapByAlbumIntent(Context context, Intent data) {
        ...
        if(null!=bitmap){
            ...
            try{
                OutputStream fOut;
                FileUtils.makeDirs(Constants.IMG_PATH);
                File file = new File(Constants.IMG_PATH, filename + ".jpg");
...
//        }
    ...
    public static Bitmap getAdjustCompressBitmapByBitmap(Bitmap bitmap) {
        ...
        Bitmap bitmap1 = adjustBitmapSize(bitmap, Constants.DEF_IMG_W, Constants.DEF_IMG_H);
        return bitmap1;
    }
    ...
    public static Bitmap getAdjustCompressBitmapByPath(String path) {
        ...
        try {
            ...
            Bitmap bitmap = BitmapFactory.decodeFile(path, options);
             bitmap1 = adjustBitmapSize(bitmap, Constants.DEF_IMG_W, Constants.DEF_IMG_H);
        }catch (Exception e){
            return null;
        }
        return bitmap1;
...
//        return dateStr + userId + "/" + timeStampMd5 + ".jpg";
    ...
    public static void setbitmap(final String imageUri, final ImageView imageView) throws IOException {
        ...
        }.executeOnExecutor(BaseApplication.TASK_EXECUTOR);
    }
