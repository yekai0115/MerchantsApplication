...
public class HandyRadioButton extends AppCompatRadioButton {

	private int mDrawableSize;// xml文件中设置的大小

	public HandyRadioButton(Context context) {
		this(context, null, 0);
	}

	public HandyRadioButton(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public HandyRadioButton(Context context, AttributeSet attrs, int defStyle) {
		...
		for (int i = 0; i < n; i++) {
			...
			case R.styleable.MyRadioButton_drawableBottom:
				...
				break;
			case R.styleable.MyRadioButton_drawableRights:
