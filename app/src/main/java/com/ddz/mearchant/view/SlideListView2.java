 ...
 * @author zhangshuo
 */
public class SlideListView2 extends ListView implements Pullable {
	...
	private boolean isUpNoList =false;
	private boolean isDownNoList =false;
	/**
	...
	public void setPullUp(boolean upNolist){
		isUpNoList = upNolist;
	}
	public void setPullDown(boolean downNolist){
		isDownNoList = downNolist;
	}
}