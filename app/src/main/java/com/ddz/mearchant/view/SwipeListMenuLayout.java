 ...
 * 
 */
public class SwipeListMenuLayout extends FrameLayout {
	...
	private SwipeListMenuView mMenuView;
	private int mDownX;
	...
	public SwipeListMenuLayout(View contentView, SwipeListMenuView menuView) {
	...
	private SwipeListMenuLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	private SwipeListMenuLayout(Context context) {
		super(context);
	}
	...
	public SwipeListMenuView getMenuView() {
		return mMenuView;
	}
