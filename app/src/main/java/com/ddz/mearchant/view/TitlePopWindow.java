...
public class TitlePopWindow extends PopupWindow implements OnItemClickListener,OnTouchListener {
	...
	private TitlePopAdapter.PopItemClickListener mListener;

	public TitlePopWindow(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public TitlePopWindow(Activity activity, int width, int height, ArrayList<Custom> mActionItems){
	...
	public void setPopItemClickListener(TitlePopAdapter.PopItemClickListener listener){
		this.mListener=listener;
	}
	public TitlePopAdapter.PopItemClickListener getListener(){
